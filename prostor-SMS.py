...
async def service_handler(message: Message, state: FSMContext):
    ...
    await message.answer(
        "Отлично! Мы уже передали информацию персональный менеджер спешит вам помочь и активировать бонус. А пока вы можете получить доступы для тестирования зарегистрируйтесь на сайте https://clck.ru/3GJ8Cj"
    )
